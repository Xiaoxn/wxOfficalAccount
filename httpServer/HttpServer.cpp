...
void HttpServer::slotOnGetAccessToken(int nCode, QString sMsg, QString sToken)
{
    ...
    if(!sToken.isEmpty()) {
        ...
        sub_button4.buttonMap.insert("name", "本周课表");
        sub_button4.buttonMap.insert("type", "view");
        sub_button4.buttonMap.insert("url", "https://xiaoxn.github.io/wxOfficalAccount/timeTable/src/login.html");
        buttonMenu3.subButtonList.append(sub_button4);
        sub_button5.buttonMap.insert("name", "考试成绩");
        sub_button5.buttonMap.insert("type", "view");
        sub_button5.buttonMap.insert("url", "https://xiaoxn.github.io/wxOfficalAccount/queryResult/login.html");
        buttonMenu3.subButtonList.append(sub_button5);
        sub_button6.buttonMap.insert("name", "作息时间");
